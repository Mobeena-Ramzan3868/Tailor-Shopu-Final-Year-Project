...
<div class="nav-bar" id="navbar" style="display: none;">
    ...
    function processForm()
    {
        ...
        if ($missingFields) {
            ...
            $query = "UPDATE faq SET fquestion=?, fanswer=? WHERE fid=$fid";
    ...
    function displayForm($missingFields)
    {
        ...
        $query1 = "SELECT fid, fquestion, fanswer FROM faq WHERE fid=$fid";
    ...
    ?>
            <div class="container">
                <h1>Update FAQ</h1>
                <form action="faqsupdate.php?fid=<?php echo $fid; ?>" method="post">
                    <?php if ($missingFields) { ?>
                        <p class="error">FILLING IN ALL FIELDS ARE MANDATORY</p>
                    <?php } ?>
                    <div class="form">
                        <input type="text" name="fquestion" id="" placeholder="Enter your FAQ question" <?php validateField("fquestion", $missingFields) ?> value="<?php echo $fquestion ?>">
                    </div>
                    <div class="form">
                        <textarea name="fanswer" id="fanswer" cols="30" rows="4" placeholder="Enter your FAQ Answer" <?php validateField("fanswer", $missingFields) ?>><?php echo $fanswer  ?></textarea>
                    </div>
